...
public class NextDoctorUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form class='formarea' name='frm' action='FinalUpd' method='Post'>");
		...
		out.println("<br><button type='submit' name='s' class='btn' style='color:white;background-color:gray;'>save</button>");
