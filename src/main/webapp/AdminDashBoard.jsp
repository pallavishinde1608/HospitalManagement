...
<body>
    ...
    <a class="button" href="AddRecep.jsp"> <img src="<%="images/receptionist.png"%>" class="img3">Receptionist</a>
    <a class="button" href="AddDoctor.jsp"> <img src="<%="images/doctor1.png"%>" class="img3">Doctor</a>
